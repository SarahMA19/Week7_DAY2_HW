...
Now its POSSIBLE to write OOP JS code
...
// pullPizzaPut(cookPizza(preHeatOven())) - conceptually
...
Higher order functions - these are the ones getting funs passed to them

callback function - any func passed as input to another

Do these exist in Python? Yes, byt the are not as nearly as common. For examples
...
// call the fuction using the promose with .then() and .catch()
// .then() reps resolve
// .catch() reps reject
...
let giveRaise = async (salary, raise) => {
    ...
    // AWAIT the reslts of the promise
    console.log(`This is your new salary: ${newSalary}`);
}

giveRaise(5000, 10000)
